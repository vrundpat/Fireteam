...
class JoinModal extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = { member_power_val: 1100 };
                    ...
                    <div className="row">
                     ...
                     <div className="row">
                        <div className="col form-group member-power-slider-root">
                            ...
                            <input className="member-power-slider" type="range" name="member_power_val" min="1100" max="1400" value={this.state.member_power_val} onInput={this.handleSliderValue}/>
                        </div>
                    </div>               
                    <div className="row">
                            <div className="col form-group">
