                    ...
                    <div className="row">
                     ...
                     <div className="row">
                        <div className="col form-group member-power-slider-root">
                            ...
                            <input className="member-power-slider" type="range" name="member_power_val" min="750" max="1080" value={this.state.member_power_val} onInput={this.handleSliderValue}/>
                        </div>
                    </div>               
                    <div className="row">
                            <div className="col form-group">
